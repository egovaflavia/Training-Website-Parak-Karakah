...
<section class="p-t-20">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="title-5 m-b-35"> <a href="cetak/cetak_nonformal.php" target="_blank" class="fa fa-print"> Print</a></h3>
                <div align="center">
                    <div align="center"><br>
                ...
                <h3 class="col-md-12" align="center"><u>Laporan Data Sarana Non Fromal</u></h3>
                <br>
                <br>
