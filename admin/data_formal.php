...
<section class="p-t-20">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="title-5 m-b-35">data Sarana Formal</h3>
                <div class="table-data__tool">
                    <p class="desc">Data Sarana Formal hanya Dapat di Edit</p>
                </div>
                                ...
                                <td>
                                    <div class=" table-data-feature">
                                        <button name="edit" class=" item" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <a class="zmdi zmdi-edit" href="backup_index.php?page=aksi/edit_formal&id=<?php echo $data['id_formal']; ?>"></a>
                                        </button>
                                    </div>
                                </td>
                            </tr>
