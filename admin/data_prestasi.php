            ...
            <div class="col-md-12">
                ...
                <div class="table-data__tool">
                    <div class="table-data__tool-right">
                        <a class="au-btn au-btn-icon au-btn--green au-btn--small" href="?page=aksi/add_prestasi">Tambah Data</a>
                    </div>
                </div>
                                ...
                                <td>
                                    <div class=" table-data-feature">
                                        <button name="edit" class=" item" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <a class="zmdi zmdi-edit" href="backup_index.php?page=aksi/edit_prestasi&id=<?php echo $data['id_prestasi']; ?>"></a>
                                        </button>
                                        <button name="hapus" class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                            <a class="zmdi zmdi-delete" href="aksi/hapus_prestasi.php?id=<?php echo $data['id_prestasi']; ?>"></a>
                                        </button>
                                    </div>
                                </td>
                            </tr>
